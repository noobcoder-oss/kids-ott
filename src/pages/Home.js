...
const Home = () => {
  ...
  const categories = [
    ...
    },
    {
      title: "Series",
      content: [
        ...movies.filter((m) => m.genre?.includes("Drama")),
        ...series.filter((s) => s.genre?.includes("Drama")),
      ],
      type: "mixed",
      link: "/series",
    },
    ...
    showInfoModal &&
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              "bg-white text-[#e31b53] border border-[#e31b53] rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto",
          },
          React.createElement(
            "div",
          ...
          React.createElement(
            ...
            React.createElement(
              Link,
              {
                to: `${category.link}`,
                className:
                  "text-sm sm:text-base text-[#e31b53] hover:text-[#ff2d6d] transition-colors",
              },
              "View More"
            )
          ),
